...
description: "Pembaca dapat membedakan hardware partition dari support grab bar, merencanakan backing/substrate, clearance, fixing, dan inspection."
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Koordinasi Grab Bar dan Cubicle Partition”
- **Reader and situation:** Arsitek, accessibility reviewer, dan installer
- **Reader outcome:** Pembaca dapat membedakan hardware partition dari support grab bar, merencanakan backing/substrate, clearance, fixing, dan inspection.
- **Primary intent:** Mencegah salah tumpu grab bar
...
- **Scope boundary:** Tidak mengizinkan grab bar ditumpu panel tanpa engineered evidence; layout aksesibel dimiliki CUB-05-A01 dan struktur/fixing CUB-06-A02.
- **Final public route:** `/artikel/koordinasi-grab-bar-cubicle-partition.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Koordinasi Grab Bar dan Cubicle Partition**.
...
- **Tie back to this article:** Keep the explanation specific to “Koordinasi Grab Bar dan Cubicle Partition”.
