...
description: "Pembaca dapat memilih physical sample, finish board, hardware board, office/toilet mock-up, electrical document/test evidence, acceptance owner, and change control."
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Sample, Mock-up, dan Submittal sebagai Gate Pembelian Cubicle”
- **Reader and situation:** Procurement dan design team
- **Reader outcome:** Pembaca dapat memilih physical sample, finish board, hardware board, office/toilet mock-up, electrical document/test evidence, acceptance owner, and change control.
- **Primary intent:** Menetapkan pre-award/pre-production evidence
...
- **Scope boundary:** Tidak menyamakan sample kecil dengan system certification; system mock-up dimiliki CUB-05-A08 dan CUB-08-A07, electrical evidence CUB-12-A07.
- **Final public route:** `/artikel/sample-mockup-submittal-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sample, Mock-up, dan Submittal sebagai Gate Pembelian Cubicle**.
...
- **Tie back to this article:** Keep the explanation specific to “Sample, Mock-up, dan Submittal sebagai Gate Pembelian Cubicle”.
