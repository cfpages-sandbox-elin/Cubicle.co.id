...
description: "Pembaca dapat merekam user range, posture variation, task, display, input, reach, legroom, chair, accessories, and mock-up needs memakai basis standar terkini."
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Brief Ergonomi Workstation Berdasarkan Pengguna dan Tugas”
- **Reader and situation:** HR, HSE, workplace designer, dan procurement
- **Reader outcome:** Pembaca dapat merekam user range, posture variation, task, display, input, reach, legroom, chair, accessories, and mock-up needs memakai basis standar terkini.
- **Primary intent:** Menyusun kebutuhan ergonomi
...
- **Scope boundary:** Tidak memberi satu ukuran untuk semua orang atau menyatakan diagnosis medis; layout dimiliki CUB-08-A01 dan ISO 9241-5:2024 harus dicek saat drafting.
- **Final public route:** `/artikel/brief-ergonomi-workstation.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Brief Ergonomi Workstation Berdasarkan Pengguna dan Tugas**.
...
- **Tie back to this article:** Keep the explanation specific to “Brief Ergonomi Workstation Berdasarkan Pengguna dan Tugas”.
