---
article_id: CUB-14-A08
title: "Punch List Cubicle Listrik: Kapan Defect Menahan Pengiriman atau Energization"
slug: "punch-list-cubicle-listrik"
description: "Panduan praktis membedakan cacat keselamatan, fungsi, dokumen, dan tampilan serta menentukan penahanan, bukti perbaikan, uji ulang, dan kewenangan pelepasan."
status: draft
...
date_modified: null
parent_topic: CUB-14
primary_intent: "Mengklasifikasikan defect dan hold point"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/punch-list-cubicle-listrik.html"
...
Gunakan empat kelas defect berikut sebagai bahasa kerja, bukan sebagai pengganti klasifikasi kontrak:

| Kelas | Contoh pola temuan | Dampak keputusan |
|---|---|---|
| Safety | interlock, pembumian, penghalang, atau akses yang belum terbukti aman | Hold pengiriman dan energization sampai diperbaiki serta diverifikasi |
| Functional | mekanisme, indikasi, trip, komunikasi, atau urutan operasi gagal | Hold energization; pengiriman hanya mungkin dengan containment dan persetujuan tertulis |
| Document | drawing/as-built, sertifikat, hasil uji, atau serial tidak cocok | Hold bila menghambat identifikasi, inspeksi, atau otorisasi; jangan menutup dengan foto saja |
| Cosmetic | cacat tampilan yang tidak memengaruhi fungsi atau keselamatan | Dapat menjadi punch terbuka dengan batas waktu dan kriteria penerimaan yang disepakati |
...
- **Energi dan paparan.** Apakah perbaikan dapat dilakukan tanpa membuka bagian bertegangan atau menghilangkan penghalang? Jika jawabannya tidak jelas, jangan energize.
- **Fungsi yang saling bergantung.** Interlock, indikasi, remote signal, dan urutan operasi harus diuji terhadap skenario penggunaan yang disetujui, bukan hanya gerakan mekanis satu kali.
- **Perubahan material atau konfigurasi.** Substitusi, lubang tambahan, fixing berbeda, atau support yang dipindah dapat membatalkan bukti sebelumnya. Compact laminate, misalnya, memiliki pertimbangan perubahan dimensi akibat kelembapan; detail proyek harus merujuk sistem dan instruksi pabrik yang tepat, bukan nama material generik.
- **Bukti dan ketertelusuran.** Dokumen tanpa nomor serial, revisi, tanggal, atau saksi yang diwajibkan tidak cukup untuk menghubungkan hasil uji ke unit.
- **Kondisi lokasi.** Akses, proteksi transportasi, fondasi, alignment, dan kesiapan interface harus dinilai oleh tim proyek. [NEEDS SITE READINESS DAN ACCEPTANCE CRITERIA]
...
| Temuan | Containment | Bukti penutupan | Keputusan sementara |
|---|---|---|---|
| Interlock tidak bekerja pada skenario uji | Kunci operasi dan beri tag hold | Perbaikan, retest skenario lengkap, saksi berwenang | Tahan pengiriman dan energization |
| Drawing revision di unit berbeda dari submittal | Karantina unit, hentikan instalasi lanjutan | Approved revision, redline/as-built, verifikasi serial | Tahan persetujuan lanjut sampai identitas pulih |
| Label komponen kurang tetapi fungsi belum terdampak | Cegah commissioning dengan label ambigu | Label sesuai daftar, inspeksi ulang, update dokumen | Pengiriman bersyarat hanya bila kontrak mengizinkan; energization ditahan bila identifikasi kritis |
| Goresan pada panel, proteksi dan fungsi terbukti | Lindungi permukaan, tetapkan batas perbaikan | Foto, pemeriksaan visual, acceptance tertulis | Boleh open punch kosmetik dengan due date |
...
Kesalahan kedua adalah memakai istilah “minor” sebelum menilai mode kegagalan. Tanyakan: jika defect memburuk saat transportasi atau operasi, apakah orang, peralatan, atau proses dapat terdampak? Bila ya, naikkan ke engineering tinjauan.

Kesalahan ketiga adalah menganggap FAT yang lulus otomatis membolehkan energization di lokasi. FAT hanya menjawab ruang lingkup FAT; perubahan, interface, dan kondisi lokasi dapat memerlukan pemeriksaan atau SAT tambahan. [NEEDS FAT/SAT cakupan DAN TEST RECORD YANG DISETUJUI]
