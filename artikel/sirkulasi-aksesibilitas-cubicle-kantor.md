---
article_id: CUB-08-A05
title: "Sirkulasi dan Aksesibilitas di Antara Cubicle Kantor"
slug: "sirkulasi-aksesibilitas-cubicle-kantor"
description: "Pembaca dapat memetakan approach, turning/passing, chair pullback, accessible workstation, emergency route, and obstruction risks."
status: draft
...
date_modified: null
parent_topic: CUB-08
primary_intent: "Menilai route dan clearances kantor"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/sirkulasi-aksesibilitas-cubicle-kantor.html"
...
# Sirkulasi dan Aksesibilitas di Antara Cubicle Kantor

Halo, Sobat Cubicle.co.id! Sirkulasi di antara cubicle tidak cukup dinilai dari apakah orang masih bisa berjalan. Yang perlu dipastikan adalah apakah seseorang dapat mendekati workstation, berpapasan atau berbelok tanpa tersangkut, menarik kursi, memakai peralatan, dan keluar melalui rute yang memang disetujui. Satu lorong yang tampak lapang di denah bisa menyempit setelah kursi, pedestal, kabel, atau pintu dibuka.

Jawaban singkatnya: petakan rute sebagai rangkaian pendekatan (approach), ruang berputar (turning), ruang berpapasan (passing), dan ruang tarik-kursi (chair pullback), lalu uji terhadap pengguna, furnitur, serta kondisi operasi. Angka minimum dari contoh atau katalog tidak otomatis membuktikan aksesibilitas. Permen PUPR No. 14/PRT/M/2017 menempatkan aksesibilitas sebagai hubungan antara jalur, pintu, ruang, perlengkapan, dan cara penggunaan; detail proyek dan tinjauan profesional tetap menentukan ([status regulasi](https://peraturan.bpk.go.id/Details/104477/permen-pupr-no-14prtm2017-tahun-2017), [teks PDF](https://peraturan.bpk.go.id/Download/136346/PermenPUPR14-2017.pdf)).
...
**Perbedaan pengguna.** Anak tangga, kursi roda, tongkat, keterbatasan jangkauan, dan kebutuhan pendamping menghasilkan kebutuhan manuver yang berbeda. Tanyakan profil pengguna yang menjadi dasar desain dan lakukan uji dengan perwakilan yang relevan bila tersedia. Satu angka dari referensi asing hanya ilustrasi koordinasi; bukan dasar menyatakan kepatuhan di Indonesia.

**Bangunan dan keadaan darurat.** Kolom, sprinkler, pintu tahan api, signage, dan rute keluar dapat membatasi lokasi cubicle. Jangan menukar rute harian dengan rute evakuasi tanpa persetujuan pihak yang mengelola keselamatan gedung. Klaim fire atau egress memerlukan bukti sistem dan tinjauan tersendiri.

## Contoh keputusan praktis

Gunakan tabel berikut saat rapat layout. Isinya adalah keputusan proses, bukan angka kepatuhan.

| Temuan saat uji | Keputusan sementara | Bukti yang diminta |
|---|---|---|
| Jalur lurus bebas, tetapi kursi menutup simpul belok | Geser workstation atau ubah orientasi meja; jangan mengecilkan rute di gambar | Denah kondisi kursi ditarik dan foto/mock-up |
| Dua arus bertemu di depan pintu | Pisahkan titik tunggu dari lintasan; cek ayun pintu | Rencana pintu, skenario jam sibuk, persetujuan facility |
| Workstation “aksesibel” hanya dapat dicapai melewati pedestal | Pindahkan pedestal atau sediakan sisi pendekatan yang benar-benar bebas | Peta pendekatan dan uji penggunaan |
| Kabel melintang pada jalur | Reroute melalui jalur yang terlindung dan dapat diperiksa | Detail kabel, metode penutup, inspeksi pascapasang |
| Cubicle mengurangi lebar rute gedung | Hentikan pemasangan pada segmen itu dan minta tinjauan egress/fire | Gambar koordinasi gedung dan keputusan profesional |

Kawan Cubicle.co.id, bedakan “bisa lewat sekali” dari “dapat digunakan berulang”. Minta penguji menjalankan rute pergi-pulang, berbalik, berhenti, dan kembali setelah pintu atau kursi dioperasikan. Catat bagian mana yang bergantung pada perilaku disiplin; bagian itu membutuhkan aturan operasi, bukan sekadar revisi gambar.
...
Sirkulasi dan aksesibilitas di antara cubicle kantor ditentukan oleh rute yang dapat didekati, dibelokkan, dilewati, dan digunakan dalam kondisi nyata—termasuk kursi ditarik, pintu dibuka, dan barang hadir. Mulailah dengan peta rute dan kondisi operasi, lalu koordinasikan workstation aksesibel, jalur gedung, dan rute darurat dengan pihak yang berwenang.
