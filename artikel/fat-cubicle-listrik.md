...
description: "Pembaca dapat menyusun scope, approved procedures, instruments, calibration, serials, routine verification, functional tests, witness/hold points, results, defects, and release."
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Menyusun FAT Cubicle Listrik yang Bisa Ditelusuri”
- **Reader and situation:** Owner, witness, EPC, dan manufacturer
- **Reader outcome:** Pembaca dapat menyusun scope, approved procedures, instruments, calibration, serials, routine verification, functional tests, witness/hold points, results, defects, and release.
- **Primary intent:** Menyiapkan factory acceptance test
...
- **Scope boundary:** Tidak menentukan test voltage/current atau membuka equipment untuk pembaca umum; design evidence dimiliki CUB-12-A07 dan test dilakukan personel kompeten.
- **Final public route:** `/artikel/fat-cubicle-listrik.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menyusun FAT Cubicle Listrik yang Bisa Ditelusuri**.
...
- **Tie back to this article:** Keep the explanation specific to “Menyusun FAT Cubicle Listrik yang Bisa Ditelusuri”.
