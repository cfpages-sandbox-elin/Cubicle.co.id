...
- **Writer task:** Expand this file into one complete article answering: “Panelboard, MDB, Switchboard, MCC, Switchgear, atau RMU?”
- **Reader and situation:** Owner, buyer, dan non-specialist project team
- **Reader outcome:** Pembaca dapat membedakan fungsi, voltage range, switching/protection role, construction, maintenance, and typical application sebelum meminta produk.
- **Primary intent:** Mengklasifikasikan electrical assembly
...
- **Scope boundary:** Tidak memilih equipment atau rating; specification dimiliki CUB-12-A01 dan keputusan wajib engineer.
- **Final public route:** `/artikel/panelboard-mdb-switchboard-mcc-switchgear-rmu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Panelboard, MDB, Switchboard, MCC, Switchgear, atau RMU?**.
...
- **Tie back to this article:** Keep the explanation specific to “Panelboard, MDB, Switchboard, MCC, Switchgear, atau RMU?”.
