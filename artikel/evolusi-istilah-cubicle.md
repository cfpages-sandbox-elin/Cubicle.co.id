...
- **Writer task:** Expand this file into one complete article answering: “Mengapa Satu Kata Cubicle Menjadi Tiga Sistem Berbeda”
- **Reader and situation:** Editor, mahasiswa, dan pembaca yang membutuhkan konteks
- **Reader outcome:** Pembaca memahami bagaimana istilah kantor, toilet, dan listrik berkembang serta mengapa konteks teknis wajib disebut.
- **Primary intent:** Memahami evolusi penggunaan istilah
...
- **Scope boundary:** Tidak membuat sejarah merek atau klaim penemu; kamus istilah saat ini dimiliki CUB-01-A02.
- **Final public route:** `/artikel/evolusi-istilah-cubicle.html`
- **Appointed CMS date:** `2025-05-03` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengapa Satu Kata Cubicle Menjadi Tiga Sistem Berbeda**.
...
- **Tie back to this article:** Keep the explanation specific to “Mengapa Satu Kata Cubicle Menjadi Tiga Sistem Berbeda”.
