...
- **Writer task:** Expand this file into one complete article answering: “Fixed vs Withdrawable Switchgear”
- **Reader and situation:** Specifier menilai maintainability dan continuity
- **Reader outcome:** Pembaca dapat membandingkan access, isolation, maintenance, replacement, interlock, footprint, cost drivers, and evidence needs.
- **Primary intent:** Membandingkan construction approach
...
- **Scope boundary:** Tidak menyatakan satu tipe lebih aman tanpa complete design and procedures; service continuity categories dimiliki CUB-12-A04.
- **Final public route:** `/artikel/fixed-vs-withdrawable-switchgear.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Fixed vs Withdrawable Switchgear**.
...
- **Tie back to this article:** Keep the explanation specific to “Fixed vs Withdrawable Switchgear”.
