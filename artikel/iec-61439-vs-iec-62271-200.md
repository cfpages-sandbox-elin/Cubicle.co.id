...
description: "Pembaca dapat membedakan LV assembly general/product-part logic dari MV AC metal-enclosed scope above 1 kV through 52 kV dan kebutuhan adoption check."
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “IEC 61439 vs IEC 62271-200: Standar Mana untuk Cubicle Listrik?”
- **Reader and situation:** Buyer dan specifier menghindari salah standar
- **Reader outcome:** Pembaca dapat membedakan LV assembly general/product-part logic dari MV AC metal-enclosed scope above 1 kV through 52 kV dan kebutuhan adoption check.
- **Primary intent:** Menentukan standard family awal
...
- **Scope boundary:** Tidak menyatakan conformity dari penyebutan standar; design/routine verification evidence dimiliki CUB-12-A07 dan project edition wajib dicek.
- **Final public route:** `/artikel/iec-61439-vs-iec-62271-200.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **IEC 61439 vs IEC 62271-200: Standar Mana untuk Cubicle Listrik?**.
...
- **Tie back to this article:** Keep the explanation specific to “IEC 61439 vs IEC 62271-200: Standar Mana untuk Cubicle Listrik?”.
