...
date_modified: null
parent_topic: CUB-14
primary_intent: "Memeriksa installation prerequisites"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/site-readiness-cubicle-listrik.html"
...
# Site Readiness Sebelum Cubicle Listrik Ditempatkan

Halo, Sobat Cubicle.co.id! Cubicle listrik belum siap ditempatkan hanya karena ruangnya sudah terlihat kosong. Keputusan “boleh placing” harus menunggu bukti bahwa ruang kering dan bersih, pondasi atau channel siap, jalur masuk aman, serta pekerjaan kabel, pembumian, proteksi, izin, dan dokumen yang disetujui telah melewati titik tahan. Jika salah satu prasyarat struktural atau elektrikal belum jelas, statusnya **hold**, bukan “lanjut sambil dibenahi”.

Pemeriksaan ini adalah verifikasi kesiapan lokasi sebelum unit tiba dan diposisikan. Ia tidak menggantikan desain ruang, perhitungan struktur, koordinasi instalasi luar ruang, atau persetujuan profesional. Kerangka bangunan nasional menempatkan keselamatan, kesehatan, kenyamanan, kemudahan, fungsi, dokumentasi, dan penggunaan sebagai hal yang dapat terpengaruh oleh perubahan bangunan; label produk saja tidak membuktikan kepatuhan ([PP No. 16 Tahun 2021](https://peraturan.bpk.go.id/Details/161846/pp-no-16-tahun-2021)).
...
Mulai dari walkdown bersama site manager, owner engineer, kontraktor, pemasok, dan HSE/QA. Tandai setiap item sebagai **clear**, **clear with observation**, atau **hold**. Setiap status harus memiliki nomor gambar, revisi, foto berpenanda lokasi, hasil ukur, atau dokumen persetujuan.
...
| Temuan | Keputusan | Bukti untuk membuka hold |
|---|---|---|
| Room kering, bersih, akses dan perlindungan tersedia | Clear bersyarat | Walkdown bertanggal, foto, daftar proteksi |
| Channel terpasang tetapi level/anchor belum diverifikasi | Hold | Hasil ukur dan drawing revisi disetujui |
| Rute kabel siap, titik earth belum memiliki detail | Hold elektrikal | Detail earthing, inspeksi, dan rencana uji |
| Jalur masuk menyilang area lifting aktif | Hold logistik | Rute alternatif dan lifting plan disetujui |
| Permit ada, tetapi method statement berbeda revisi | Hold dokumen | Revisi konsisten dan tanda tangan yang berwenang |

Contoh ini adalah pola keputusan, bukan kriteria numerik universal. Owner engineer tetap menentukan acceptance criteria yang sesuai desain dan kontrak. Di bawah kerangka jasa konstruksi, pembagian peran dan dokumen proyek perlu mengikuti pengaturan yang berlaku serta kondisi kontrak; artikel ini bukan nasihat hukum ([UU No. 2 Tahun 2017](https://peraturan.bpk.go.id/Details/37637/uu); [PP No. 14 Tahun 2021](https://peraturan.bpk.go.id/Details/161844/pp-no-14-tahun-2021)).
...
Jika data level, anchor, earthing, fire interface, atau acceptance criteria belum tersedia, pertahankan status hold dan tandai **[NEEDS PROJECT/PROFESSIONAL REVIEW]**. Aturan operasinya sederhana: tidak ada placing ketika risiko struktural atau elektrikal belum memiliki bukti dan persetujuan yang dapat ditelusuri.
