...
description: "Pembaca dapat memilih count, observation window, booking/log data, survey, privacy safeguard, baseline, and decision rule."
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Mengukur Okupansi dan Pemakaian Cubicle Tanpa Mengganggu Privasi”
- **Reader and situation:** Workplace strategist dan facility analyst
- **Reader outcome:** Pembaca dapat memilih count, observation window, booking/log data, survey, privacy safeguard, baseline, and decision rule.
- **Primary intent:** Mengumpulkan evidence untuk redesign
...
- **Scope boundary:** Tidak mengidentifikasi atau memantau individu; hybrid planning dimiliki CUB-08-A04 dan case-study governance CUB-17-A06.
- **Final public route:** `/artikel/mengukur-okupansi-cubicle-kantor.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengukur Okupansi dan Pemakaian Cubicle Tanpa Mengganggu Privasi**.
...
- **Tie back to this article:** Keep the explanation specific to “Mengukur Okupansi dan Pemakaian Cubicle Tanpa Mengganggu Privasi”.
