...
date_modified: null
parent_topic: CUB-15
primary_intent: "Menyusun maintenance strategy"
reader_community: "Cubicle.co.id"
reader_address: "Kawan Cubicle.co.id"
final_route: "/artikel/program-inspeksi-cubicle-listrik.html"
...
- **Writer task:** Expand this file into one complete article answering: “Program Inspeksi Cubicle Listrik Berbasis Risiko”
- **Reader and situation:** Asset manager dan authorized maintenance planner
- **Reader outcome:** Pembaca dapat menggabungkan criticality, manufacturer guidance, duty, environment, history, condition indicators, shutdown opportunities, task competence, and records.
- **Primary intent:** Menyusun maintenance strategy
...
- **Scope boundary:** Tidak menetapkan interval atau task universal; detailed work procedure and access authorization remain site-specific.
- **Final public route:** `/artikel/program-inspeksi-cubicle-listrik.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Program Inspeksi Cubicle Listrik Berbasis Risiko**.
...
- **Tie back to this article:** Keep the explanation specific to “Program Inspeksi Cubicle Listrik Berbasis Risiko”.
