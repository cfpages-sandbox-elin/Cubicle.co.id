...
date_modified: null
parent_topic: CUB-04
primary_intent: "Memverifikasi spesifikasi panel phenolic"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/membaca-data-sheet-panel-phenolic.html"
...
- **Writer task:** Expand this file into one complete article answering: “Cara Membaca Data Sheet Panel Phenolic dan Compact Laminate”
- **Reader and situation:** Buyer, QS, arsitek, dan inspector submittal
- **Reader outcome:** Pembaca dapat menemukan identitas produk, komposisi, ketebalan, densitas, permukaan, toleransi, moisture/fire evidence, dan batas aplikasi.
- **Primary intent:** Memverifikasi spesifikasi panel phenolic
...
- **Scope boundary:** Tidak menyamakan semua phenolic/HPL; perbandingan dengan material lain dimiliki CUB-04-A01.
- **Final public route:** `/artikel/membaca-data-sheet-panel-phenolic.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara Membaca Data Sheet Panel Phenolic dan Compact Laminate**.
...
- **Tie back to this article:** Keep the explanation specific to “Cara Membaca Data Sheet Panel Phenolic dan Compact Laminate”.
