...
- **Writer task:** Expand this file into one complete article answering: “Kamus Cubicle Indonesia: Cubicle, Kubikel, Partisi, Panel, dan Switchgear”
- **Reader and situation:** Pemilik, pembeli, penulis spesifikasi, dan pencari jasa
- **Reader outcome:** Pembaca dapat memakai istilah Indonesia/Inggris yang konsisten dan mengenali istilah yang bukan sinonim teknis.
- **Primary intent:** Memahami istilah yang sering tertukar
...
- **Scope boundary:** Tidak menjadi katalog tipe; tipe toilet dimiliki CUB-03-A02, workstation CUB-08-A03, dan perangkat listrik CUB-11-A02.
- **Final public route:** `/artikel/kamus-cubicle-kubikel-partisi-panel-switchgear.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kamus Cubicle Indonesia: Cubicle, Kubikel, Partisi, Panel, dan Switchgear**.
...
- `CUB-01-A01` → `/artikel/arti-cubicle-kantor-toilet-listrik.html` — Arti Cubicle: Bedakan Kubikel Kantor, Toilet, dan Listrik
- `CUB-01-A03` → `/artikel/cara-membaca-brief-cubicle.html` — Cara Membaca Brief yang Hanya Menulis “Cubicle”
...
- **Tie back to this article:** Keep the explanation specific to “Kamus Cubicle Indonesia: Cubicle, Kubikel, Partisi, Panel, dan Switchgear”.
