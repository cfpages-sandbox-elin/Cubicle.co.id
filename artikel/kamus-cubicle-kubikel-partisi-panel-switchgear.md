---
article_id: CUB-01-A02
title: "Kamus Cubicle Indonesia: Cubicle, Kubikel, Partisi, Panel, dan Switchgear"
slug: "kamus-cubicle-kubikel-partisi-panel-switchgear"
description: "Pembaca dapat memakai istilah Indonesia/Inggris yang konsisten dan mengenali istilah yang bukan sinonim teknis."
status: draft
...
date_modified: null
parent_topic: CUB-01
primary_intent: "Memahami istilah yang sering tertukar"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/kamus-cubicle-kubikel-partisi-panel-switchgear.html"
...
# Kamus Cubicle Indonesia: Cubicle, Kubikel, Partisi, Panel, dan Switchgear

Halo, Sobat Cubicle.co.id!

Kata *cubicle*, *kubikel*, *partisi*, *panel*, dan *switchgear* sering muncul dalam satu kebutuhan awal, padahal tidak menunjuk benda yang sama. Jawaban singkatnya: **cubicle/kubikel adalah sebutan ruang atau unit yang harus dijelaskan konteksnya; partisi adalah sistem pembatas ruang; panel adalah elemen atau lembar penyusun; switchgear adalah perangkat dan rakitan kelistrikan.** Istilah Indonesia dan Inggris boleh dipakai bersamaan, asalkan objek, fungsi, dan batas pekerjaannya ditulis.
...
**Kaca dan aluminium.** Keduanya dapat menjadi bagian partisi, tetapi “kaca partisi” tidak sama dengan spesifikasi keselamatan lengkap. BSN mencatat standar terpisah untuk kaca pengaman laminasi dan kaca pengaman dikeraskan, yaitu SNI 9144-1:2022 dan SNI 9144-2:2022 ([laminasi](https://pesta.bsn.go.id/produk/detail/14416-sni9144-12022), [dikeraskan](https://pesta.bsn.go.id/produk/detail/14417-sni9144-22022)). Pilihan produk tidak dengan sendirinya menentukan ketebalan, ukuran, lubang, tepi, pintu, hardware, atau kemampuan angkur. **[NEEDS PROJECT REVIEW: G-01, G-03, G-13]**
...
- **Tinggi dan bukaan.** Partisi setengah tinggi, dinding penuh, pintu lebar, dan bukaan untuk kaca menerima tuntutan stabilitas serta detail kepala yang berbeda.
...
|---|---|---|
| “Buat cubicle kantor” | Ruang kerja untuk siapa, tinggi berapa, dan apa yang ditopang? | Partisi ruang kerja lengkap dengan panel, rangka, pintu, dan interface |
| “Pakai panel HPL” | HPL sebagai lapisan atau panel kompak? Substrat dan tepi bagaimana? | Lapisan HPL pada substrat tertentu **atau** panel laminasi kompak |
| “Pasang partisi kaca” | Kaca pengaman mana, ukuran, tepi, pintu, dan angkurnya? | Partisi kaca dengan jenis kaca, frame/fitting, dan detail support |
| “Sediakan cubicle listrik” | Kompartemen atau switchgear? Fungsi switching dan proteksinya apa? | Rakitan switchgear dengan spesifikasi kelistrikan dan dokumen produk |
...
Ketiga, menganggap plafon grid selalu dapat menahan partisi atau beban gantung. Minta jalur beban dan titik angkur ditunjukkan pada gambar; jangan menerima asumsi tanpa telaah struktur. Keempat, menggunakan “kaca tempered” sebagai jawaban lengkap. Periksa retensi pecahan, tepi, human impact, pintu, hardware, dan fungsi pengaman pada konteks terpasang. **[NEEDS PROFESSIONAL REVIEW: G-01, G-03, G-06, G-13]**

Checklist singkat sebelum menyetujui istilah:

- objek dan fungsi tertulis dalam satu kalimat;
- komponen dan interface tercantum;
- bukti produk dibedakan dari bukti sistem dan bukti proyek;
- batas yang belum terverifikasi diberi penanda, bukan diisi dengan asumsi;
- istilah switchgear dipisahkan dari pekerjaan partisi dan interior.
...
Teman Cubicle.co.id, sebelum meminta harga atau menyetujui gambar, ubah setiap istilah menjadi kalimat yang menyebut fungsi, komponen, interface, dan bukti yang akan diperiksa. Simpan pertanyaan terbuka untuk tinjauan proyek; jangan mengubah label produk menjadi klaim kepatuhan. Jika Anda perlu menyamakan konteks layanan terlebih dahulu, gunakan [beranda Cubicle.co.id](/) sebagai titik awal, lalu bawa kamus mini itu ke vendor dan profesional terkait.

Aturan operasionalnya sederhana: **tidak ada istilah yang boleh menggantikan objek, detail pemasangan, dan bukti penerimaan.**
...
- **Exact Markdown to insert:** `![Ilustrasi cubicle panel](/wp-content/uploads/2023/01/cubicle-panel.jpg)`
