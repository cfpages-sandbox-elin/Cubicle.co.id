...
- **Writer task:** Expand this file into one complete article answering: “Internal Separation dan Service Continuity pada Electrical Assembly”
- **Reader and situation:** Electrical specifier dan operations team
- **Reader outcome:** Pembaca dapat memahami separation forms/categories yang relevan, access implications, maintenance continuity, fault containment limitations, and verification questions.
- **Primary intent:** Menentukan maintainability architecture
...
- **Scope boundary:** Tidak mencampur terminology LV IEC 61439 dengan MV IEC 62271; fixed/withdrawable choice dimiliki CUB-11-A05.
- **Final public route:** `/artikel/internal-separation-service-continuity.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Internal Separation dan Service Continuity pada Electrical Assembly**.
...
- **Tie back to this article:** Keep the explanation specific to “Internal Separation dan Service Continuity pada Electrical Assembly”.
