...
- **Writer task:** Expand this file into one complete article answering: “Anatomi Cubicle Listrik: Busbar, Breaker, Kabel, Metering, Proteksi, dan Kontrol”
- **Reader and situation:** Owner representative dan trainee non-operasional
- **Reader outcome:** Pembaca dapat membaca diagram kompartemen dan menghubungkan bagian fisik dengan single-line tanpa membuka equipment.
- **Primary intent:** Mengenali compartments dan fungsi
...
- **Scope boundary:** Tidak menjadi panduan membuka cubicle atau menyentuh bagian internal; access control dimiliki CUB-15-A01.
- **Final public route:** `/artikel/anatomi-cubicle-listrik.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Anatomi Cubicle Listrik: Busbar, Breaker, Kabel, Metering, Proteksi, dan Kontrol**.
...
- `CUB-11-A01` → `/artikel/panelboard-mdb-switchboard-mcc-switchgear-rmu.html` — Panelboard, MDB, Switchboard, MCC, Switchgear, atau RMU?
- `CUB-11-A02` → `/artikel/kamus-rating-nameplate-cubicle-listrik.html` — Kamus Rating dan Istilah pada Nameplate Cubicle Listrik
- `CUB-11-A04` → `/artikel/incoming-bus-coupler-feeder-cubicle.html` — Incoming, Bus Coupler, dan Feeder Cubicle pada Single-Line Diagram
...
- **Tie back to this article:** Keep the explanation specific to “Anatomi Cubicle Listrik: Busbar, Breaker, Kabel, Metering, Proteksi, dan Kontrol”.
