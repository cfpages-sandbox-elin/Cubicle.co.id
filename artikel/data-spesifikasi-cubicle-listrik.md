...
date_modified: null
parent_topic: CUB-12
primary_intent: "Menyiapkan specification inputs"
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/data-spesifikasi-cubicle-listrik.html"
...
# Data yang Wajib Ada dalam Spesifikasi Cubicle Listrik
...
Bagian protection/control harus menyebut fungsi, bukan hanya nama alat. Daftarkan trip, alarm, indikasi, interlock, local/remote, sumber bantu, fail-safe, komunikasi, dan titik uji. Hubungkan setiap fungsi dengan cause-and-effect, wiring diagram, daftar I/O, serta filosofi operasi. Angka pickup, delay, atau kurva selektivitas tetap [NEEDS ENGINEERING STUDY] sampai perhitungan disetujui.

Buat verification matrix sejak tahap permintaan penawaran. Untuk tiap requirement, tunjukkan bukti yang diterima: datasheet, gambar tersertifikasi, inspeksi material, witness atau titik tahan, uji fungsi, rekaman kalibrasi, dan as-built. Bagian tersembunyi tidak boleh hanya diverifikasi setelah ditutup; dokumentasikan sebelum penutupan. Permen PUPR No. 10 Tahun 2021 dapat menjadi rujukan kerangka keselamatan konstruksi, tetapi tidak menggantikan metode dan persetujuan proyek ([Permen PUPR No. 10 Tahun 2021](https://peraturan.bpk.go.id/Details/216875/permen-pupr-no-10-tahun-2021)).
...
6. Setujui ITP (inspection and test plan, yaitu rencana inspeksi dan pengujian) dengan saksi, titik tahan, kriteria penerimaan, dan rekaman yang diwajibkan.
7. Setelah instalasi, lakukan pemeriksaan visual, pemeriksaan koneksi, uji fungsi, dan commissioning sesuai prosedur yang disetujui.
8. Tutup punch list dan serahkan as-built, sertifikat, hasil uji, manual, daftar suku cadang, serta register deviasi yang sudah diputuskan.
