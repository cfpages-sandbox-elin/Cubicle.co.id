...
description: "Pembaca dapat menilai inward/outward swing, konflik sirkulasi, pengguna jatuh, emergency release, dan akses maintenance."
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Arah Buka Pintu Cubicle Toilet: Ruang, Evakuasi, dan Bantuan Darurat”
- **Reader and situation:** Desainer toilet umum dan operator fasilitas
- **Reader outcome:** Pembaca dapat menilai inward/outward swing, konflik sirkulasi, pengguna jatuh, emergency release, dan akses maintenance.
- **Primary intent:** Memilih door swing dan emergency access
...
- **Scope boundary:** Tidak menentukan kepatuhan aksesibel sendirian; workflow dimiliki CUB-05-A01 dan hardware emergency dimiliki CUB-05-A06.
- **Final public route:** `/artikel/arah-buka-pintu-cubicle-toilet.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Arah Buka Pintu Cubicle Toilet: Ruang, Evakuasi, dan Bantuan Darurat**.
...
- `CUB-05-A01` → `/artikel/desain-cubicle-toilet-aksesibel.html` — Alur Desain Cubicle Toilet Aksesibel di Indonesia
- `CUB-05-A02` → `/artikel/worksheet-ukuran-cubicle-toilet.html` — Worksheet Ukuran Cubicle Toilet dari Ruang Bersih hingga Clear Opening
- `CUB-05-A04` → `/artikel/privasi-dan-celah-cubicle-toilet.html` — Menutup Sightline dan Celah Privasi Cubicle Toilet
- `CUB-05-A05` → `/artikel/cubicle-toilet-anak-keluarga-ambulant.html` — Cubicle Toilet Anak, Keluarga, dan Pengguna Ambulant
...
- **Tie back to this article:** Keep the explanation specific to “Arah Buka Pintu Cubicle Toilet: Ruang, Evakuasi, dan Bantuan Darurat”.
